...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    fetchAllData();
  }, [userAddress, getDashboardInfo, globalStats, GetSponserId]);
        ...
        {loading ? (
          ...
          <>
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-10">
              <RamaCard label="Current Rama Price (Dollar)" value={globalData?.globalRama ? ("$" + parseFloat(globalData.globalRama).toFixed(6)) : "N/A"} />
              <StatCard label="Wallet Balance" value={isConnected && globalData?.walletBalance ? globalData.walletBalance.toString() : "Not Connected"} />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                ...
                <div className="bg-white/50 dark:bg-gray-900/30 backdrop-blur-sm p-5 rounded-lg shadow-lg border border-admin-new-green/30 hover:border-admin-new-green hover:shadow-xl hover:shadow-admin-new-green/20 transition-all duration-300">
                  ...
                  <div className="mt-2 flex gap-5">
                    ...
                    <p className='dark:text-admin-cyan-dark'> User ID : {sponserId || 'N/A'}</p>
                  </div>
                </div>
